...
# в обоих наборах.
# Пользователь вводит 2 числа. n - 
# кол-во элементов первого множества. m - 
...
num_set = num_set_1.union(num_set_2)

print("Общий набор", num_set)
...
lis = [ int(x) for x in input( ' введите число  ягод на кусте в одну строчку через пробел -> ' ).split() ]
n = len(lis)
lis = lis + lis[:2]
sbor = 0
for i in range(n):
    sbor = max( sbor, lis[i] + lis[i+1] + lis[i+2] )
print(" С трех кустов в лучшем случае можно собрать ", sbor)